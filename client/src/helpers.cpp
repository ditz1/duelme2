...
void DrawDebugInfo(GameState game, Player& client_player, std::array<Player, 4> all_players) {
            ...
            DrawText(TextFormat("Player 0: %d", all_players[0].anim_frame_counter), x_start_other, y_start_other + y_spacing * 2, font_size, RAYWHITE);
            DrawText(TextFormat("Player 1: %d", all_players[1].anim_frame_counter), x_start_other, y_start_other + y_spacing * 3, font_size, RAYWHITE);
            DrawText(TextFormat("Player 2: %d", all_players[2].anim_frame_counter), x_start_other, y_start_other + y_spacing * 4, font_size, RAYWHITE);
            DrawText(TextFormat("Player 3: %d", all_players[3].anim_frame_counter), x_start_other, y_start_other + y_spacing * 5, font_size, RAYWHITE);
